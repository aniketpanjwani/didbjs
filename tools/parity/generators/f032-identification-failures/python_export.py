#!/usr/bin/env python3
"""Generate Python reference artifacts for F032 identification failures."""
...
SCENARIOS: dict[str, dict[str, Any]] = {
    ...
    "one_cohort": {},
    "all_post_treated": {},
    "no_supported_horizon": {"horizons": [1]},
}
...
def main() -> int:
    ...
    log_parts = [
        f"F032_PYTHON_INPUT={args.input_csv}",
        f"F032_PYTHON_OUTPUT={args.output_dir}",
        f"PYTHON_VERSION={sys.version}",
    ]

    for scenario, spec in SCENARIOS.items():
        data = panel[panel["scenario"] == scenario].copy()
    ...
    diagnostics = {
        ...
        "source": "pinned Python did_imputation identification-failure probes",
    }
